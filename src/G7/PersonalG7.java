 ...
 * @author Familia
 */
public class PersonalG7 extends javax.swing.JFrame {
    ...
    sql="SELECT * FROM personal  WHERE unidad='G7'"; 
    ...
    sql="SELECT * FROM personal WHERE unidad='G7' && ced_per='"+valor+"'";
    
    }
        /*try{
                        Statement s = cn.createStatement();
        ResultSet rst = s.executeQuery("SELECT * FROM personal");
        
        while (rst.next()){
        //rut.setText(rs.getString(1));
            
                unidad=rst.getString("unidad");
...
int ced=0;
    ...
    String []dato = new String[7];
        ...
        //rut.setText(rs.getString(1));
                ...
                if(unidad.equals("G7")){
                    ...
                    ced=rst.getInt("ced_per");
                
                    
    sql="SELECT * FROM situacion WHERE ced_per='"+ced+"'"; 
    ...
    sql="SELECT * FROM situacion WHERE ced_per='"+valor+"'"; 
            ...
            TBperson.setModel(model);}}else{JOptionPane.showMessageDialog(null, "Ingrese la Cedula de\nUn personal de su Unidad");}
        }
                }
    ...
    String []dato = new String[6];
        ...
        Statement s = cn.createStatement();
        ResultSet rst = s.executeQuery("SELECT * FROM personal WHERE  unidad='G7'");
    
         while (rst.next()){
        id=rst.getString("id_prom");
            System.out.println(id);
            sql="SELECT * FROM promocion where id_prom='"+id+"'";
    ...
    String []dato = new String[5];
        ...
        ResultSet rst = s.executeQuery("SELECT * FROM personal WHERE unidad='G7'");
         ...
         while (rst.next()){
        serial=rst.getString("ser_armp");
            System.out.println(
            serial);
    
    sql="SELECT * FROM armamentop where ser_armp='"+serial+"'"; 
        ...
        Statement s = cn.createStatement();
        ResultSet rst = s.executeQuery("SELECT * FROM personal WHERE ced_per='"+TXTced.getText()+"' && unidad='G7'");
    ...
    String []dato = new String[8];
        ...
        //rut.setText(rs.getString(1));
                ...
                if(unidad.equals("G7")){
                    ...
                    ced=rst.getInt("ced_per");
    sql="SELECT * FROM familiares where ced_per='"+ced+"'"; 
...
TBperson.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Registrosg7 ir = new Registrosg7();
        ir.setVisible(true);
        dispose();
  ...
  BtnBuscarArma.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonalG7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonalG7().setVisible(true);
            }
        });
    }
